    ...
    <label className='flex cursor-pointer items-center'>
      <div className='relative'>
        <input
          ...
          id={id}
        />
        <div className='flex h-6 w-6 items-center justify-center rounded-md border border-gray-400 bg-white shadow-inner transition-all duration-300 ease-in-out'>
          {isChecked && (
            <svg
