...
>
  ...
  {/* Mobile: normal flow (left). Desktop: absolute centered. */}
  <Link
    href="/"
    className="flex items-center md:absolute md:inset-y-0 md:left-1/2 md:-translate-x-1/2 md:transform"
  >
    <Image
      src="/assets/images/logo-main.png"
      height={59}
  ...
  {/* Mobile actions: hamburger only (no Get Started pill) */}
  <div className="md:hidden flex items-center gap-x-2">
    <button
      className='cursor-pointer'
      onClick={openMobileMenu}
