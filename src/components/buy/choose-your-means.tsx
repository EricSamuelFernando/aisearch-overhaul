...
const ChooseYourMeans = ({
  ...
  return (
    <section className="bg-[#FFF6EC] pt-8 pb-6 sm:pt-10 sm:pb-8 px-4 sm:px-8 lg:px-12 text-center">
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="satoshi text-xs sm:text-sm text-[#8E8B8A] mb-6 sm:mb-8 max-w-[600px] mx-auto">
        ...
        {/* Card Grid Layout */}
        <div
          className="flex flex-nowrap gap-6 overflow-x-auto pb-2 bg-transparent scrollbar-hide snap-x snap-mandatory sm:flex-wrap sm:justify-center sm:overflow-visible sm:snap-none"
        >
          {/* Team member 1 */}
          <div className="min-w-[240px] sm:min-w-0 rounded-2xl overflow-hidden relative cursor-pointer">
            <img
