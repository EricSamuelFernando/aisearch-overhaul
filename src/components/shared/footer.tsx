        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[260px_180px_200px_1fr] md:items-center">
          ...
          <div className="flex items-center justify-end mt-8 translate-y-4">
            <div className="text-sm text-white/80 leading-relaxed max-w-[750px]">
              <p>
              <span className="font-semibold text-white">Disclaimer:</span> The RentvsBuy
              calculator on Snaphomz is for informational and illustrative purposes
              only. Results are based on assumptions and inputs you provide and do not
              constitute financial, legal, tax, or lending advice. Actual costs,
              interest rates, and eligibility may differ from the figures shown.
              Snaphomz is not a lender, broker, or financial advisor. Before making any
              housing or financing decisions, consult a licensed mortgage professional,
              financial advisor, and/or tax professional.
              </p>
              <div className="mt-4">
