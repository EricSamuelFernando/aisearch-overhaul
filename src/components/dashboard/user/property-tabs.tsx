    ...
    <div className='flex flex-col overflow-auto'>
      ...
      <div className='h-full w-full '>
        {activeTab === 'Document' && (
          <>
            {/* Sub-tabs for Disclosure */}
            <div className="flex flex-col sm:flex-row h-max p-2 items-start sm:items-center justify-between gap-2 sm:gap-x-8">
              {/* Search Input */}
              <CustomInput
                placeholder="Search Document"
              ...
              {/* Summarize Button */}
              <div className="w-full sm:w-1/3 py-1 flex sm:justify-end" onClick={() => setIsPaymentModalOpen(true)}>
                <button className="flex items-center justify-between gap-x-2 rounded-3xl bg-black px-3 sm:px-4 py-2 text-white text-sm sm:text-base w-full sm:w-auto">
