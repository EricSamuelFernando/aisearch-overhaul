...
export const MARK_ONE_NOTIFICATION_AS_READ = '/notifications/read/one/';
export const MARK_ALL_AS_READ = '/notifications/read/all/';
export const MARK_THREAD_NOTIFICATIONS_AS_READ = '/notifications/read/thread/';
export const MARK_LINK_NOTIFICATIONS_AS_READ = '/notifications/read/link';
