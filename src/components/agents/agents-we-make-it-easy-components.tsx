...
const lWeMakeItEasyComponent = ({ data = [] }: WeMakeItEasyComponentProp) => {
      ...
      {data.map(({ Icon, description, title }) => (
        ...
        >
          <Image
            ...
            alt='icon-image'
          />
          <h4 className='h-16 w-72 px-8 whitespace-pre-line text-xl font-medium leading-8'>
            {title}
          </h4>
...
export default lWeMakeItEasyComponent;
