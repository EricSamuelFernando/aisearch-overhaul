  ...
  return (
    ...
    >
      <head>
        ...
        <script
          key="google-maps"
          src={`https://maps.googleapis.com/maps/api/js?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY || process.env.NEXT_PUBLIC_MAP_KEY}&libraries=places,geometry,drawing`}
          async
          defer
        />
      </head>
