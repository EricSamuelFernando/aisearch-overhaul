        ...
        <CardHeader className="pb-4 px-4 md:px-6 pt-6">
          ...
          <div className="lg:hidden flex flex-col w-full gap-4">
            <div className="flex gap-1 bg-[#2A1C14] rounded-lg p-1 items-center w-full">
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium transition-colors whitespace-nowrap flex-1 ${timeRange === 'All'
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium transition-colors whitespace-nowrap flex-1 ${timeRange === '3M'
                    ? 'bg-[#100C07] text-white'
                    : 'text-[#8B7D6B] bg-transparent hover:bg-[#4A3F35]'
                  }`}
              >
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium transition-colors whitespace-nowrap flex-1 ${timeRange === '6M'
                    ? 'bg-[#100C07] text-white'
                    : 'text-[#8B7D6B] bg-transparent hover:bg-[#4A3F35]'
                  }`}
              >
          ...
          <div className="hidden lg:flex flex-row items-center justify-between relative">
            ...
            <div className="flex gap-1 bg-[#2A1C14] rounded-[15px] p-1 items-center justify-center absolute right-0">
              <button
                onClick={() => setTimeRange('All')}
                className={`rounded-full px-4 py-1.5 text-sm font-medium transition-colors whitespace-nowrap ${timeRange === 'All'
                    ? 'bg-[#100C07] text-white'
              ...
              <button
                onClick={() => setTimeRange('3M')}
                className={`rounded-full px-4 py-1.5 text-sm font-medium transition-colors whitespace-nowrap ${timeRange === '3M'
                    ? 'bg-[#100C07] text-white'
                    : 'text-[#8B7D6B] hover:bg-[#4A3F35]'
                  }`}
              >
              ...
              <button
                onClick={() => setTimeRange('6M')}
                className={`rounded-full px-4 py-1.5 text-sm font-medium transition-colors whitespace-nowrap ${timeRange === '6M'
                    ? 'bg-[#100C07] text-white'
                    : 'text-[#8B7D6B] hover:bg-[#4A3F35]'
                  }`}
              >
        ...
        <CardContent className="h-full w-full py-4 px-4 md:px-6">
          ...
          <div className="hidden lg:flex flex-wrap items-center gap-2 mb-6">
            {roomTypes.map((room) => (
              ...
              >
                <span
                  className={`text-[14px] font-medium ${selectedRooms.includes(room)
                      ? 'text-[#2A1C14]'
                      : 'text-[#B3A498]'
                    }`}
                >
