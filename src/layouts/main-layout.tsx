...
function MainLayout({ children }: Readonly<Props>) {
  ...
  const shouldHideHeaderFooter = ['sell', 'agents', 'company', 'home','terms-condition','privacy-policy','cookie-policy','offer-terms','disclosure'].some(path => pathname.includes(path));
