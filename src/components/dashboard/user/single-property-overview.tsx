...
// function SingleListingOverview() {
...
//       <Link href='/dashboard' className='flex items-center  px-[3.219rem]'>
//         <Image
...
//             Once your property is verified, you can publish.
//           </p>
//         </section>
...
// export default SingleListingOverview
