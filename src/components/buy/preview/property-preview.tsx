          ...
          <div className="mx-auto w-full max-w-[1920px] px-2 sm:px-4 md:px-6 xl:px-[78px] min-[1536px]:max-[1919px]:px-[52px] min-[1920px]:px-[94px]">
            ...
            <div className="col-span-12 lg:col-span-4 xl:col-span-1 lg:row-span-2 mt-4 lg:mt-0 xl:pl-[24px]">
              ...
              <div className="hidden lg:block mt-4 xl:mt-[54px] lg:sticky lg:top-36 lg:self-start">
                <div className="w-full rounded-2xl bg-white shadow-lg border border-[#EDEDED] p-4 sm:p-5 md:p-6 xl:w-[543px] min-[1536px]:max-[1919px]:w-[454px] xl:rounded-[16px] xl:p-[32px] xl:shadow-[0px_-4px_4px_0px_rgba(189,189,189,0.1),0px_125px_35px_0px_rgba(189,189,189,0),0px_80px_32px_0px_rgba(189,189,189,0.01),0px_45px_27px_0px_rgba(189,189,189,0.05),0px_20px_20px_0px_rgba(189,189,189,0.09),0px_5px_11px_0px_rgba(189,189,189,0.1)]">
                  {/* Header */}
                  <div className="flex items-center gap-2 mb-2 xl:mb-[12px]">
                    ...
                    <h3 className="text-[20px] font-semibold xl:text-[22px]">Ask AI</h3>
                  </div>

                  <div className="text-[14px] text-gray-600 leading-relaxed mb-5 xl:text-[21px] xl:leading-[32px] xl:text-[#484747] xl:mb-[20px]">
                    {aiAnswer ? (
                  ...
                  <div className="space-y-3 mb-6 xl:space-y-[24px] xl:mb-[20px]">
                    {(aiSuggestions || []).map((label: string, index: number) => (
                      <button
                        ...
                        className="w-full text-left rounded-xl bg-[#F6F6F6] px-4 py-3 cursor-pointer flex items-center justify-between text-[14px] hover:bg-[#F0F0F0] transition-colors xl:h-[60px] xl:rounded-[10px] xl:bg-[#F3F3F3] xl:px-[25px] xl:text-[18px]"
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full border border-[#D9D9D9] rounded-xl px-4 py-3 text-[14px] mb-5 outline-none focus:ring-0 focus:border-gray-400 transition-colors pr-12 xl:h-[60px] xl:rounded-[10px] xl:border-[#8C8C8C] xl:px-[25px] xl:text-[18px] xl:text-[#5A5A5A] xl:mb-[20px]"
                      value={askAIQuestion}
                  ...
                  <button
                    ...
                    className="w-full bg-black text-white py-3 rounded-full text-[16px] font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed xl:h-[64px] xl:rounded-[32px] xl:text-[22px]"
                  >
