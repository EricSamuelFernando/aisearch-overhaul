...
export const InviteExternalAgent: React.FC = () => {
    ...
    const { externalAgentIvitationMutation, createUserByEmailMutation } = useUserAuthApi();
    ...
    const sendAgentInvitation = async () => {
        setLoading(true)
        const data = {
        ...
        await createUserByEmailMutation.mutateAsync({ email, accountType: 'AGENT' }, {
            onSuccess: async (response: any) => {
                ...
                await axios.post(`${AI_SEARCH_ENDPOINT}/api/selling_agent`, agentInvitationData)
                setLoading(false)
                success({ message: "All set you're invitation on it's way!" });
