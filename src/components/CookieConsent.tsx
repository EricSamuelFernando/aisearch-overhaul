...
export default function CookieConsent() {
  ...
  return createPortal(
    <div
      className="
        fixed z-[9999]
        /* Mobile: fill between gutters, auto width */
        left-4 right-4
        bottom-[max(env(safe-area-inset-bottom),1rem)]
        w-auto
        /* Desktop: EXACT same position/size as before */
        md:left-4 md:right-auto md:bottom-12 md:w-[604px]
      "
    >
      <div className="bg-white rounded-2xl shadow-2xl p-6 relative">
        {/* Mobile-only small mascot pinned; desktop mascot unchanged below */}
        ...
        <div className="md:flex md:justify-between md:items-start mb-4">
          <div className="flex-1">
            <h3 className="text-gray-800 text-base font-semibold mb-2">Hi!</h3>
            <h2 className="text-gray-900 text-xl font-bold mb-3">We've got cookies</h2>
            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
              We use cookies to keep Snaphomz running smoothly and to make your home-finding journey a little smarter.
            </p>
          </div>
        ...
        <div className="mb-4 border-1 border-zinc-500 rounded-xl p-3">
          <p className="text-gray-900 text-sm font-bold mb-3">We'd also like to use:</p>
          <div className="space-y-2">
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <div className="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center flex-shrink-0">
