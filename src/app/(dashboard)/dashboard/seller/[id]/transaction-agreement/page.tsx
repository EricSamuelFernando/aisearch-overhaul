...
const TransactionAgreementPage: React.FC = () => {
  ...
  const meansOptions = [
    {
      label: 'Lack of Legal Protection',
      value: true,
      meansType: "your_agents"
    },
    {
      label: 'Limited Recourse for Disputes',
      value: true,
  ...
  return (
    <>
      <div className='grid h-full bg-orange-50 justify-between gap-x-16 md:grid-cols-4'>
        ...
        <div className='col-span-3 grid grid-cols-2 gap-10 pt-8'>
          ...
          <div className='flex h-[400px] w-full min-w-[400px] flex-col justify-start gap-10 rounded-2xl bg-white px-14 py-8'>
            <h2 className='text-lg font-bold'>Potential Risks Involved</h2>
      ...
      <div className='flex w-full bg-orange-50 flex-nowrap items-center justify-between px-0 pb-5 md:px-5'>
        ...
        <div className='flex flex-nowrap items-center gap-5'>
          <Link
            href={`/start-process/${id}/estimated-cost`}
          ...
          <Button
            onClick={() => {
              setIsRedirecting(true);
              router.push(`/dashboard/seller/sell-agreement?id=${id}`)
            }}
            disabled={isLoading || !selectedMeans || isRedirecting}
...
const stepList: StepProp[] = [
  {
    ...
    desc: 'Assisted for self compose',
    key: 'approved',
    icon: Icons.Tour,
    content: [
